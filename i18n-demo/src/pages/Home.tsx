      ...
      <div className="home-header">
        ...
        <Trans i18nKey="home.description">
          <p className="home-description">
            Explore the powerful features of <b>react-i18next</b> internationalization library.
            Click on any feature in the sidebar to see live examples and learn how to implement
            multilingual support in your React applications.
          </p>
        </Trans>
      </div>
